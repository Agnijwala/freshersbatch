...
public class Tree {
	...
	public static void main(String[] args) {
		   Long a=Long.valueOf("3425674598");
	        ...
	        contact a1=new contact(a,"chandu","chandu@gmail.com",Gender.male);
	        contact a2=new contact(b,"sree","sree@gmail.com",Gender.female);
	        contact a3=new contact(c,"anil","anil@gmail.com",Gender.male);
	        contact a4=new contact(d,"mani","mani@gmail.com",Gender.male);
